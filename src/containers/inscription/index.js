          ...
          {isLoading ? (
            ...
            <div>
              ...
              <p>
                ...
                télécharger le{" "}
                <a href="http://www.agsd.fr/images/content/inscription/preinscription.pdf">
                  formulaire d’inscription
                </a>{" "}
                et la{" "}
                <a href="http://www.agsd.fr/images/content/inscription/assurance.pdf">
                  la feuille d'assurance
                </a>{" "}
              ...
              <p>
                ...
                munir du{" "}
                <Link to="/certificat-medical">certificat médical</Link> de non
                contre-indication « à la pratique du sport en compétition ».
              </p>
              <p>3- Un chèque à l’ordre de "Avant Garde Saint-Denis".</p>
              <p>
                Vous pouvez envoyer votreline-height dossier complet à l’adresse
              ...
              <p>
                Mais attention, aucune inscription ne sera acceptée par courrier
                !
              </p>
              ...
              <p>
                L’ensemble des chèques doit être remis lors de l’inscription.
              </p>
              <p>
                Vous devez impérativement vous déplacer au secrétariat pour
